...
class EnvironmentConfig {
  ...
  private getApiBaseUrl(environment: string): string {
    switch (environment) {
      ...
      case 'staging':
        return process.env.API_BASE_URL || 'https://staging-api.testoria.com';
      case 'production':
        return process.env.API_BASE_URL || 'https://api.testoria.com';
      default:
        return process.env.API_BASE_URL || 'http://localhost:3001';
    }
  }
  ...
  private getUIBaseUrl(environment: string): string {
    switch (environment) {
      ...
      case 'staging':
        return process.env.UI_BASE_URL || 'https://staging.testoria.com';
      case 'production':
        return process.env.UI_BASE_URL || 'https://testoria.com';
      default:
        return process.env.UI_BASE_URL || 'http://localhost:3001';
    }
  }
  ...
  private getAdminBaseUrl(environment: string): string {
    switch (environment) {
      ...
      case 'staging':
        return process.env.ADMIN_BASE_URL || 'https://admin-staging.testoria.com';
      case 'production':
        return process.env.ADMIN_BASE_URL || 'https://admin.testoria.com';
      default:
        return process.env.ADMIN_BASE_URL || 'http://localhost:3021';
    }
  }
